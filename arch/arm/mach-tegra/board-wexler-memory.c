...
static const struct tegra_emc_table qc750_emc_tables_micron[] = {
	{
		0x32,       /* Rev 3.2 */
...
static const struct tegra_emc_table qc750_emc_tables_samsung[] = {
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table qc750_emc_tables_elpida[] = {
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table qc750_emc_tables_nanya[]= {
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
int kai_emc_init(void)
{
	...
	if(mem_selecter == 0){
		tegra_init_emc(qc750_emc_tables_micron,
				ARRAY_SIZE(qc750_emc_tables_micron));
		pr_info("QC750: Micron 1GB DDR3\n");
	}

	if(mem_selecter == 1){
		tegra_init_emc(qc750_emc_tables_samsung,
				ARRAY_SIZE(qc750_emc_tables_samsung));
		pr_info("QC750: Samsung 1GB DDR3\n");
	}

	if(mem_selecter == 2){
		tegra_init_emc(qc750_emc_tables_elpida,
				ARRAY_SIZE(qc750_emc_tables_elpida));
		pr_info("QC750: Elpida 1GB DDR3\n");
	}

	if(mem_selecter == 3){
		tegra_init_emc(qc750_emc_tables_nanya,
				ARRAY_SIZE(qc750_emc_tables_nanya));
		pr_info("QC750: Nanya 1GB DDR3\n");
	}
