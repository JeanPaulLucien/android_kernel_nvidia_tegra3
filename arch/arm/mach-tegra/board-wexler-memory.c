/*
 * arch/arm/mach-tegra/board-wexler-memory.c
 *
...
static const struct tegra_emc_table nabi2_emc_tables_elpida[] = {
#if 1
	{
		0x32,       /* Rev 3.2 */
...
static const struct tegra_emc_table nabi2_emc_tables_micron[] = {
	#if 1
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
...
static const struct tegra_emc_table nabi2_xd_emc_tables_elpida[] = {
#if 1
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
...
static const struct tegra_emc_table birch_emc_tables_elpida[] = {
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table birch_emc_tables_elpida_ext[] = {
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table nabi2_xd_emc_tables_micron[] = {
	#if 1
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
...
static const struct tegra_emc_table nabi2_emc_tables_nanya[]= {
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table nabi2_xd_emc_tables_nanya[]= {
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table birch_emc_tables_hynix_ext[] = {
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table birch_emc_tables_hynix[] = {
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table nabi2_emc_tables_samsung[] = {
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table nabi2_xd_emc_tables_samsung[] = {
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
int kai_emc_init(void)
{
	int ret;
	int mem_selecter=2;
	ret = gpio_request(TEGRA_GPIO_PG4, "TEGRA_GPIO_PG4");
	if (ret < 0) {
		pr_err("%s: gpio_request failed for gpio %s\n",
			__func__, "TEGRA_GPIO_PG4");
	}
	
	ret = gpio_request(TEGRA_GPIO_PG5, "TEGRA_GPIO_PG5");
	if (ret < 0) {
		pr_err("%s: gpio_request failed for gpio %s\n",
			__func__, "TEGRA_GPIO_PG5");
	}
	gpio_direction_input(TEGRA_GPIO_PG4);
	gpio_direction_input(TEGRA_GPIO_PG5);
	
	mem_selecter = (gpio_get_value(TEGRA_GPIO_PG4)*2+gpio_get_value(TEGRA_GPIO_PG5));

	pr_err("kai_emc_init:==================>mem_selecter = %d,pg4=%d,pg5=%d\n",mem_selecter,gpio_get_value(TEGRA_GPIO_PG4),gpio_get_value(TEGRA_GPIO_PG5));
	
	//tegra_init_emc(kai_emc_tables_h5tc4g,
		      // ARRAY_SIZE(kai_emc_tables_h5tc4g));
#if 1
	if(mem_selecter==0){
		if(machine_is_nabi2_xd()||machine_is_n1010() || machine_is_itq700() 
		|| machine_is_itq701() || machine_is_mm3201()||machine_is_n710()
		||machine_is_qc750()||machine_is_n750() || machine_is_birch()
		||machine_is_wikipad()||machine_is_ns_14t004())
		{
		    tegra_init_emc(nabi2_xd_emc_tables_micron,
                    ARRAY_SIZE(nabi2_xd_emc_tables_micron));
		}
		else
		{
		    tegra_init_emc(nabi2_emc_tables_micron,
		            ARRAY_SIZE(nabi2_emc_tables_micron));
		}
		pr_err("kai_emc_init:==================> use micron ddr3\n");
	}else if(mem_selecter==1){
	...
	if(machine_is_nabi2_xd()||machine_is_n1010() || machine_is_itq700() 
		...
		tegra_init_emc(nabi2_xd_emc_tables_samsung,
           		    ARRAY_SIZE(nabi2_xd_emc_tables_samsung));
		pr_err("kai_emc_init:========nabi2_xd_emc_tables_samsung==========> use samsung/new elpida ddr3\n");
		}
		else{
		tegra_init_emc(nabi2_emc_tables_samsung,
               ARRAY_SIZE(nabi2_emc_tables_samsung));
		pr_err("kai_emc_init:==================> use samsung/new elpida ddr3\n");
		}
	}else if(mem_selecter==2){
		if(machine_is_nabi2_xd()||machine_is_n1010() || machine_is_itq700() 
		|| machine_is_itq701() || machine_is_mm3201()||machine_is_n710()
		||machine_is_qc750()||machine_is_n750()
		||machine_is_wikipad()||machine_is_ns_14t004())
		{
		    tegra_init_emc(nabi2_xd_emc_tables_elpida,
                   ARRAY_SIZE(nabi2_xd_emc_tables_elpida));
		}
		else if(machine_is_birch())
		{
				tegra_init_emc(birch_emc_tables_elpida_ext,
                   ARRAY_SIZE(birch_emc_tables_elpida_ext));
        pr_err("kai_emc_init:==================> device is birch\n");
		}
		else
		{
			tegra_init_emc(nabi2_emc_tables_elpida,
                   ARRAY_SIZE(nabi2_emc_tables_elpida));
		}
		pr_err("kai_emc_init:==================> use  elpipa ddr3\n");
	}else if(mem_selecter==3){

		if(machine_is_nabi2_xd()||machine_is_n1010() || machine_is_itq700() 
		|| machine_is_itq701() || machine_is_mm3201()||machine_is_n710()
		||machine_is_qc750()||machine_is_n750()
		||machine_is_wikipad()||machine_is_ns_14t004()){
			tegra_init_emc(nabi2_xd_emc_tables_nanya,
           		    ARRAY_SIZE(nabi2_xd_emc_tables_nanya));
			pr_err("kai_emc_init:======== use nanya ddr3\n");
		}
		else if(machine_is_birch())
		{
		    tegra_init_emc(birch_emc_tables_hynix_ext,
                   ARRAY_SIZE(birch_emc_tables_hynix_ext));
        pr_err("kai_emc_init:==================> device is birch\n");
        pr_err("kai_emc_init:==================> use  hynix ddr3\n");
		}
		else{
		tegra_init_emc(nabi2_emc_tables_nanya,
               ARRAY_SIZE(nabi2_emc_tables_nanya));
		pr_err("kai_emc_init:==================> use  nanya ddr3\n");
		}
	}
