/*
 * arch/arm/mach-tegra/board-wexler-pinmux.c
 *
...
static __initdata struct tegra_pingroup_config kai_pinmux_common[] = {
	...
	DEFAULT_PINMUX(GMI_AD14,        RSVD1,           NORMAL, NORMAL,     INPUT),
	...
	DEFAULT_PINMUX(GPIO_PBB5,       VGP5,            PULL_UP,    NORMAL,     INPUT),
	...
	VI_PINMUX(VI_D2,           VI,            NORMAL,    NORMAL,   INPUT, DEFAULT, DISABLE),
	VI_PINMUX(VI_D3,           VI,            NORMAL,    NORMAL,   INPUT, DEFAULT, DISABLE),
	VI_PINMUX(VI_D4,           VI,            NORMAL,    NORMAL,   INPUT, DEFAULT, DISABLE),
	VI_PINMUX(VI_D5,           VI,            NORMAL,    NORMAL,   INPUT, DEFAULT, DISABLE),
	VI_PINMUX(VI_D6,           VI,            NORMAL,    NORMAL,   INPUT, DEFAULT, DISABLE),
	VI_PINMUX(VI_D7,           VI,            NORMAL,    NORMAL,   INPUT, DEFAULT, DISABLE),
	VI_PINMUX(VI_D8,           VI,            NORMAL,    NORMAL,   INPUT, DEFAULT, DISABLE),
	VI_PINMUX(VI_D9,           VI,            NORMAL,    NORMAL,   INPUT, DEFAULT, DISABLE),
	...
	DEFAULT_PINMUX(GMI_AD15,        RSVD1,           NORMAL,   NORMAL,     INPUT),
