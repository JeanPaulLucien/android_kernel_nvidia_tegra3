/*
 * arch/arm/mach-tegra/board-wexler-power.c
 *
...
MAX77663_PDATA_INIT(ldo4, 800000, 1587500, NULL, 0, 0, 0,
		    1, 1, 1000000, FPS_SRC_0, -1, -1, LDO4_EN_TRACKING | ADE_DISABLE);
...
int __init nabi2_hold_avdd_usb(void){
	struct regulator *vdd_reg = regulator_get(NULL, "avdd_usb");
	if(vdd_reg){
		printk("always hold the avdd for usb detection\n");
